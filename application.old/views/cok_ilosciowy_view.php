...
<script>
    $(function(){
		$("#run_ilosciowy").click(function(){
			...
			$.getJSON("<?php echo base_url();?>raport/cok_ilosciowy_json?data_od="+data_od+"&data_do="+data_do, function(mps) {
				var functionsConfig = {
					aggregators: $.pivotUtilities.aggregators,
					renderers:   $.pivotUtilities.renderers,
					sorters: {						
						Data: function(a,b){ return b-a; }
					}
				};
				var serializedConfig = '{"rows":["Agent"], "cols":["Data"],'+
								'"vals":["Liczba połączeń odebranych"],"aggregatorName":"Integer Sum"}';
